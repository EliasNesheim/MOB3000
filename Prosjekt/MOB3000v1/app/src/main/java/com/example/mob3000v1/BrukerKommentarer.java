...
public class BrukerKommentarer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bruker_kommentarer);
        ...
        Intent intent_kommentar = getIntent();
        Brukernavn = intent_kommentar.getStringExtra("brukernavn");
        ...
        String url = "http://13.49.175.230/getKommentarerBruker.php?";
        url += "user=" + Brukernavn;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(!response.contains("Ingen kommentarer")) {
                            for (int i = 0; i < kombo.length; i++) {
                                ...
                                textView.setId(i);
                                textView.setText("Din kommentar: " + "\n" + post[2]);
                            ...
                            textView.setText(R.string.ingen_kommentarer_bruker);
